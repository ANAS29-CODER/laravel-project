...
<html lang="en">
  <head>
    ...
    <!--[if lt IE 9]><script src="{{ asset('assets/front/https://oss.maxcdn.com/libs/html5shiv/3.7.0/html5shiv.js ') }}""></script><script src="{{ asset('assets/front/https://oss.maxcdn.com/libs/respond.js/1.4.2/respond.min.js ') }}""></script><![endif]-->
  </head>
