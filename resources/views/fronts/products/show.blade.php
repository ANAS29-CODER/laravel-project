            ...
            <div class="row">
                <div class="col-lg-10 col-md-12 col-lg-offset-1">
                    ...
                    <div class="ps-product__thumbnail--mobile">
                        <div class="ps-product__main-img"><img src="{{ $products->image_url }}" alt=""></div>
                        <div class="ps-product__preview owl-slider" data-owl-auto="true" data-owl-loop="true"
                            ...
                            data-owl-item-lg="3" data-owl-duration="1000" data-owl-mousedrag="on"><img
                                ...
                                alt=""><img src="images/shoe-detail/3.jpg" alt=""></div>
                    </div>
                    <div class="ps-product__info">
                        ...
                        <h1>{{ $products->name }}</h1>
                        <p class="ps-product__category"> {{ $products->category->name }}</p>
                        <h3 class="ps-product__price">£ {{ $products->price }}</del></h3>
                        ...
                        <div class="ps-product__block ps-product__style">
                            ...
                            <ul>
                                <li><a href="product-detail.html"><img src="images/shoe/sidebar/1.jpg"
                                            alt=""></a></li>
                                <li><a href="product-detail.html"><img src="images/shoe/sidebar/2.jpg"
                                            alt=""></a></li>
                                <li><a href="product-detail.html"><img src="images/shoe/sidebar/3.jpg"
                                            alt=""></a></li>
                                <li><a href="product-detail.html"><img src="images/shoe/sidebar/2.jpg"
                                            alt=""></a></li>
                            </ul>
                        ...
                        <form action="{{ route('cart.store') }}" method="POST" id="add-to-cart">
                            ...
                            <div class="ps-product__shopping">
                                <button type="submit" class="ps-btn mb-10" >Add to cart
                ...
                <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true"
                        ...
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    href="#"><i class="ps-icon-heart"></i></a><img src="images/shoe/1.jpg"
                            ...
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img src="images/shoe/2.jpg"
                                            ...
                                            src="images/shoe/4.jpg" alt=""><img src="images/shoe/5.jpg"
                                            alt=""></div>
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    href="#"><i class="ps-icon-heart"></i></a><img src="images/shoe/3.jpg"
                                    alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    href="#"><i class="ps-icon-heart"></i></a><img src="images/shoe/5.jpg"
                                    alt=""><a class="ps-shoe__overlay" href="product-detail.html"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
