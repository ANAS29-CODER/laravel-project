            ...
            <ul>
                <li class="ps-banner" data-index="rs-2972" data-transition="random" data-slotamount="default"
                    data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img class="rev-slidebg"
                        src="{{ asset('assets/front/images/slider/3.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5 ') }}"
                        data-no-retina>
                ...
                <li class="ps-banner ps-banner--white" data-index="rs-100" data-transition="random"
                    data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-rotate="0"><img
                        class="rev-slidebg"
                        src="{{ asset('assets/front/images/slider/2.jpg" alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="5 ') }}"
                        data-no-retina>
    ...
    <div class="ps-section--features-product ps-section masonry-root pt-100 pb-100">
        <div class="ps-container">
            ...
            <div class="ps-section__content pb-50">
                ...
                <x-latest-product :products="$products" />
                ...
                <div class="ps-owl--colection owl-slider" data-owl-auto="true" data-owl-loop="true"
                        ...
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    ...
                                    src="{{ asset('assets/front/images/shoe/1.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
                                            src="{{ asset('assets/front/images/shoe/2.jpg" alt=""><img src="images/shoe/3.jpg" alt=""><img src="images/shoe/4.jpg" alt=""><img src="images/shoe/5.jpg" alt=" ') }}">
                                    </div>
                        ...
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                ...
                                <div class="ps-badge ps-badge--sale ps-badge--2nd"><span>-35%</span></div><a
                                    ...
                                    src="{{ asset('assets/front/images/shoe/2.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    href="#"><i class="ps-icon-heart"></i></a><img
                                    src="{{ asset('assets/front/images/shoe/3.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                                    ...
                                    src="{{ asset('assets/front/images/shoe/4.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail">
                                <div class="ps-badge"><span>New</span></div><a class="ps-shoe__favorite"
                                    href="#"><i class="ps-icon-heart"></i></a><img
                                    src="{{ asset('assets/front/images/shoe/5.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
                    ...
                    <div class="ps-shoes--carousel">
                        <div class="ps-shoe">
                            <div class="ps-shoe__thumbnail"><a class="ps-shoe__favorite" href="#"><i
                                        class="ps-icon-heart"></i></a><img
                                    src="{{ asset('assets/front/images/shoe/6.jpg" alt=""><a class="ps-shoe__overlay" href="product-detail.html ') }}"></a>
                            </div>
                            <div class="ps-shoe__content">
                                <div class="ps-shoe__variants">
                                    <div class="ps-shoe__variant normal"><img
            ...
            <div class="owl-slider" data-owl-auto="true" data-owl-loop="true" data-owl-speed="5000"
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img
                            src="{{ asset('assets/front/images/testimonial/1.jpg" alt=""><i class="fa fa-quote-left ') }}"></i>
                    </div>
                    <header>
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img
                            src="{{ asset('assets/front/images/testimonial/2.jpg" alt=""><i class="fa fa-quote-left ') }}"></i>
                    </div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
                ...
                <div class="ps-testimonial">
                    <div class="ps-testimonial__thumbnail"><img
                            src="{{ asset('assets/front/images/testimonial/3.jpg" alt=""><i class="fa fa-quote-left ') }}"></i>
                    </div>
                    <header>
                        <select class="ps-rating">
                            <option value="1">1</option>
